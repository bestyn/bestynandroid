...
import com.gbksoft.neighbourhood.databinding.LayoutOutcomingMessageBinding
import com.gbksoft.neighbourhood.model.chat.Message
import jp.wasabeef.glide.transformations.RoundedCornersTransformation

class OutcomingMessageView : MessageView {
    private lateinit var layout: LayoutOutcomingMessageBinding
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        layout = DataBindingUtil.inflate(LayoutInflater.from(context),
                R.layout.layout_outcoming_message, this, true)
    ...
    private fun createContentManager(
            ...
            MessageContentDelegate.AudioGroup(
                    ...
                    layout.tvAudioTime,
                    null,
                    layout.ivAudioStatus
            ),
            withTextRequestOptions,
            withoutTextRequestOptions,
            R.drawable.ic_outcoming_text_to_speech_active,
            R.drawable.ic_outcoming_text_to_speech,
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        if (changed) updateContentMaxWidth()
    }
