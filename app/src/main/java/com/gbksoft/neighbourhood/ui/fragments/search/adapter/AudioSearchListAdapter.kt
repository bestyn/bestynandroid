...
import com.gbksoft.neighbourhood.databinding.AdapterAudioSearchListBinding
...
class AudioSearchListAdapter(private val audioPlaybackManager: AudioPlaybackManager) : RecyclerView.Adapter<AudioSearchListAdapter.AudioListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AudioListViewHolder {
        ...
        val layout = DataBindingUtil.inflate<AdapterAudioSearchListBinding>(layoutInflater, R.layout.adapter_audio_search_list, parent, false)
    ...
    inner class AudioListViewHolder(val layout: AdapterAudioSearchListBinding) : RecyclerView.ViewHolder(layout.root), AudioPlaybackListener,
