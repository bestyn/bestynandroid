...
class ReportUserViewModel(
    ...
    fun reportUser(reportReason: ReportReason) {
        addDisposable("reportUser", reportRepository.reportUser(userId, reportReason)
    ...
    private fun onLoadingStart() {
        showLoader()
        changeControlState(R.id.reasonFakeProfile, false)
        changeControlState(R.id.reasonPrivacyViolation, false)
        changeControlState(R.id.reasonVandalism, false)
    ...
    private fun onLoadingFinish() {
        hideLoader()
        changeControlState(R.id.reasonFakeProfile, true)
        changeControlState(R.id.reasonPrivacyViolation, true)
        changeControlState(R.id.reasonVandalism, true)
