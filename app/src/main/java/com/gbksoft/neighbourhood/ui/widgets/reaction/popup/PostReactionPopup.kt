...
class PostReactionPopup(context: Context) : ReactionPopup(context) {

    override fun inflateLayout(inflater: LayoutInflater): ViewDataBinding {
        return DataBindingUtil.inflate(inflater, R.layout.post_popup_reaction, null, false)
    }
    ...
    override fun show(parentView: View, anchorView: View) {
        ...
        popupWindow.showAtLocation(
                ...
                anchorLocationOnScreen[1] - popupHeight
        )
    }
}