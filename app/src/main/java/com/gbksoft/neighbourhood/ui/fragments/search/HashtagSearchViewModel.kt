...
import com.gbksoft.neighbourhood.ui.fragments.search.search_engine.HashtagPostsSearchEngine
...
class HashtagSearchViewModel(
    ...
    private val hashtag = hashtag.replace("#", "")
    ...
    private val searchEngine: SearchEngine = HashtagPostsSearchEngine(hashtagSearchRepository).apply {
